  ...
  constructor() {
    ...
    this.element = `
      <div class="container header__container">
        <div class="logo">
            <a class="logo__link" href="/" data-link>
              <img
                src="${this.logoImg}"
                class="logo__img"
                alt="Logo Icon">
        ...
        <nav class="nav">
            <ul class="nav__list">
                <li class="nav__item nav__item_state_active">
                    <a class="nav__link nav__link_state_hovered" href="/" data-link>Home</a>
                </li>
                <li class="nav__item">
                    <a class="nav__link" href="/catalog" data-link>Catalog</a>
                </li>
                <li class="nav__item">
                    <a class="nav__link" href="/cart" data-link>
                      <div class="cart">
                        <img class="cart__image" src="${this.cartImg}" alt="Cart Icon">
